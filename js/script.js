...
var countDownDate = new Date("July 7, 2024 00:00:00").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = "Bless the engaged couple!";
    }
}, 1000);
...
console.log('\n\n%c SAVE THE DATE: 7th July, 2024!', styles);
